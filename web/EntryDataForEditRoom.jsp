                    ...
                    <div class="row">
                        <div class="card card-body">
                            ...
                            <div class="form-group row">
                                <label style="margin-left: 15px; margin-top: 8px" class="font-weight-bold col-form-label" for="inputDescription">Escull una habitació vàlida</label>
                                <div style="margin-left: 16px; width: 300px; margin-top: 10px">
                                    <select id="inputType" class="form-control">
                                        <c:forEach items="${rooms}" var="elem">
                                            <option value="1">${elem.idHabitacio}</option>
                                        </c:foreach>
                                    </select>
                                </div>
                            </div>
