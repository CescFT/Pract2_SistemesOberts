            ...
            <div class="row">
                <div class="col-md-6 offset-md-3">
                    <div class="card card-body">
                        ...
                        <form action="http://localhost:8080/Pract2_SistemesOberts/confirm">
                            <div style="text-align: right">
                                <button type="submit" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" title="Acceptar">OK</button>
                            </div>
                        </form>
                    </div>
                </div>
